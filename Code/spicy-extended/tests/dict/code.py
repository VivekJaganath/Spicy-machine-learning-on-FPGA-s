...
def mmult(a: np.ndarray((32, 32), 'int32'),
    ...
    v_tmp = {1.23: 1.45, 3.56: 5.89, 4.212: 7.545}
    X_tmp = Dict['int', 'list[int]']
    X_tmp = {1:[8123123,92000], 2:[7123123,6213123], 3:[53123,423123]}
    e_tmp = Dict['str', 'list[str]']
    e_tmp = {"1": ["asdsd","asdasd","asdasd"], "3":["sadasd","asdasd"]}
    '''
